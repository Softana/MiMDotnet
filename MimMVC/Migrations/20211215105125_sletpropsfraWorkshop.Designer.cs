...
namespace MimMVC.Migrations
{
    ...
    [Migration("20211215105125_sletpropsfraWorkshop")]
    partial class sletpropsfraWorkshop
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationUserWorkShop", b =>
                {
                    b.Property<string>("TilmeldteBrugereId")
                        .HasColumnType("varchar(255)");

                    b.Property<int>("TilmeldteWorkshopsId")
                        .HasColumnType("int");

                    b.HasKey("TilmeldteBrugereId", "TilmeldteWorkshopsId");

                    b.HasIndex("TilmeldteWorkshopsId");

                    b.ToTable("ApplicationUserWorkShop");
                });
            ...
            modelBuilder.Entity("ApplicationUserWorkShop", b =>
                {
                    b.HasOne("MimMVC.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("TilmeldteBrugereId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MimMVC.Models.WorkShop", null)
                        .WithMany()
                        .HasForeignKey("TilmeldteWorkshopsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
