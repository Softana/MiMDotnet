...
namespace MimMVC.Migrations
{
    ...
    [Migration("20211013084716_kassererAdded3")]
    partial class kassererAdded3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MimMVC.Models.Invoice", b =>
                {
                    ...
                    b.Property<string>("ApplicationUser.FullName")
                        .HasColumnType("varchar(255)");
                    ...
                    b.HasIndex("ApplicationUser.FullName");
            ...
            modelBuilder.Entity("MimMVC.Models.Invoice", b =>
                {
                    b.HasOne("MimMVC.Models.ApplicationUser", "UserTookPart")
                        .WithMany()
                        .HasForeignKey("ApplicationUser.FullName");

                    b.Navigation("UserTookPart");
                });
