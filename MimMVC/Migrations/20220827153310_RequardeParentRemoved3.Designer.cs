...
namespace MimMVC.Migrations
{
    ...
    [Migration("20220827153310_RequardeParentRemoved3")]
    partial class RequardeParentRemoved3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MimMVC.Models.WorkShopIndmeldelse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    b.Property<int>("Gæster")
                        .HasColumnType("int");
                    ...
                    b.ToTable("WorkShopIndmeldelser");
                });
            ...
            modelBuilder.Entity("MimMVC.Models.WorkShopIndmeldelse", b =>
                {
                    b.HasOne("MimMVC.Models.ApplicationUser", "user")
                        .WithMany("TilmeldteWorkshops")
                        .HasForeignKey("userId");

                    b.HasOne("MimMVC.Models.WorkShop", "workShop")
                        .WithMany("TilmeldteBrugere")
            ...
            modelBuilder.Entity("MimMVC.Models.ApplicationUser", b =>
                {
                    b.Navigation("TilmeldteWorkshops");
                });

            modelBuilder.Entity("MimMVC.Models.WorkShop", b =>
                {
                    b.Navigation("TilmeldteBrugere");
                });
